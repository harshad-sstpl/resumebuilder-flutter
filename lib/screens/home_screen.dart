...
import 'package:resumebuilder/screens/profile_screens.dart';
import 'package:resumebuilder/screens/resume_screen.dart';
    ...
    return Scaffold(
      ...
      body: ValueListenableBuilder(
          ...
          builder: (context, box, widget) {
            final users = box.values.toList().cast<ProfileModel>();
            return ListView.builder(
                shrinkWrap: true,
                itemCount: users.length,
                itemBuilder: (context, index) {
                  var users = box.getAt(index);
                  return Container(
